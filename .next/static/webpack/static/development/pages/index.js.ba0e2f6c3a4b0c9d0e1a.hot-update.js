...
var Report = Object(mobx_react_lite__WEBPACK_IMPORTED_MODULE_17__["observer"])(function (_ref) {
  ...
  var list = data.listRaw.filter(function (row) {
    ...
    var kelas = lodash__WEBPACK_IMPORTED_MODULE_15___default.a.get(row, 'kelas_murids.0.kelas.nama_kelas');
  ...
  return __jsx(_libs_ui_UIContainer__WEBPACK_IMPORTED_MODULE_9__["default"], {
    ...
    __self: this
  }, _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(kelasList).map(function (i) {
    return __jsx("option", {
      value: i,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.ba0e2f6c3a4b0c9d0e1a.hot-update.js.map