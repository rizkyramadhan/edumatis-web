...
var Report = Object(mobx_react_lite__WEBPACK_IMPORTED_MODULE_17__["observer"])(function (_ref) {
  ...
  var list = data.listRaw.filter(function (row) {
    ...
    var kewajiban = lodash__WEBPACK_IMPORTED_MODULE_15___default.a.get(row, 'item.kewajiban.nama_kewajiban');

    if (kelas && !kelasList[kelas]) {
      kelasList[kelas] = true;
    }

    if (row.nama_kewajiban && !kewajibanList[row.nama_kewajiban]) {
      kewajibanList[row.nama_kewajiban] = true;
    }

    console.log(row.nama_kewajiban);
  ...
  return __jsx(_libs_ui_UIContainer__WEBPACK_IMPORTED_MODULE_9__["default"], {
    ...
    __self: this
  }, _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(kewajibanList).map(function (i, idx) {
    return __jsx("option", {
      value: i,
      key: idx,
      __source: {
...
//# sourceMappingURL=index.js.c0407c71280d16b327e1.hot-update.js.map